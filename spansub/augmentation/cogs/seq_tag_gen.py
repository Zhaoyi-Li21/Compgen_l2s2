...
DATA_DIR = '/data2/home/zhaoyi/compsub/augs/data/cogs/iterative-aug/'  # Directory containing original tsv data files.
#DATA_DIR = '/data2/home/zhaoyi/compsub/data/COGS/data/'
OUTPUT_DIR = '/data2/home/zhaoyi/compsub/augs/data/cogs/seqtags/'  # Directory to write sequence tagged json files.
#DATA_FILES = [f'{x}.tsv' for x in ('dev', 'gen', 'test', 'train', 'train_100')]
DATA_FILES = ['aug_cogs.spans.5.proced.txt']
...
for filename in DATA_FILES:
  ...
  for raw_example in raw_examples:
    ...
    if raw_example.distribution != 'primitive':
      tempp = reconstruct_target(example)
      x = tempp[-1]
      if tempp[-1] == ' ':
        tempp = tempp[:-1]
      assert tempp == raw_example.target
